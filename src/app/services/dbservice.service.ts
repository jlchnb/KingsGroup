...
export class DbserviceService {
  ...
  listaVehiculos = new BehaviorSubject<Vehiculo[]>([]);
  private isDbReady:
  ...
  /**
     * Método que carga en la listaVehiculos TODO el contenido de la tabla noticia
     */
  cargarNoticias() {
    let items: Vehiculo[] = [];
  ...
  /**
     ...
     */
  fetchNoticias(): Observable<Vehiculo[]> {
